...
export default function EconomyComponent() {
  ...
  async function generate() {
    ...
    setOutput(
`Generated Economic Data (Mock)

Input:
${input}

This is placeholder metadata representing trade, currency, or market systems.`
    );
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-black/40 p-6">
      <h2 className="text-lg font-semibold text-white">Economy Component</h2>
      <p className="text-xs text-slate-400 mt-1">
        Generate trade, currency, and market systems.
      </p>

      <textarea
        placeholder="Describe economic elements..."
      ...
      >
        {loading ? "Generating…" : "Generate Economy"}
      </button>
