  ...
  return (
    <div className="glass-panel rounded-2xl p-6 border border-[rgba(255,255,255,0.06)] flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1 text-[12px]">
        <span className="text-[var(--diamond-white)]/60">Brand Name</span>
        <input
          value={brandName}
          onChange={(e) => setBrandName(e.target.value)}
          placeholder="Optional — leave empty for auto‑generated brand name"
          className="
      ...
      {/* STYLE */}
      <div className="flex flex-col gap-1 text-[12px]">
        <span className="text-[var(--diamond-white)]/60">Brand Style</span>
        <select
          value={style}
      ...
      <textarea
        ...
        placeholder="Describe your brand vision, audience, tone, culture, mission, or identity…"
        className="
